  ...
  >
    ...
    >
      <stop
        ...
        style={{ stopColor: '#EFF3EE' }}
      ></stop>
      <stop
        offset="1"
        className="secondary-color-gradient"
        style={{ stopColor: '#FFA600' }}
      ></stop>
    </linearGradient>
    <path
      fill="url(#SVGID_1_)"
      d="M429.9,221.8V106.5h-38.5l-0.2,34.4l0.6,59.7l-4.4-2.4v122.7c0,28.7-16.8,45.6-37.6,45.6h-52.1v94.1
	h148.2V264.3l30.8,0.5c17.7,0.5,21.2-6.3,18.7-10.1L429.9,221.8z M75.4,421v39.5h148.2v-94.1H130C99.8,366.4,75.4,390.8,75.4,421z"
    ></path>
    <path
      d="M445.9,468.5H297.7c-4.4,0-8-3.6-8-8v-90.8h-58.1v90.8c0,4.4-3.6,8-8,8H75.4c-4.4,0-8-3.6-8-8s3.6-8,8-8h140.2v-90.8
	...
	L36.1,261.7C34.9,262.3,33.6,262.7,32.3,262.7z"
    ></path>
    <path
      d="M195.2,103.1c0,4.4-3.6,8-8,8H21.5c-4.4,0-8-3.6-8-8s3.6-8,8-8h165.6C191.6,95.1,195.2,98.6,195.2,103.1z M207.5,57.7H91.8
	...
	h-15.8c-4.4,0-8,3.6-8,8s3.6,8,8,8H301v15.8c0,4.4,3.6,8,8,8s8-3.6,8-8V71.6h15.8c4.4,0,8-3.6,8-8S337.2,55.6,332.8,55.6z"
    ></path>
  </svg>
)
