...
export const ShoppingListIcon = () => (
  ...
  >
    ...
    <path
      fill="url(#SVGID_1_)"
      d="M393.4,185.7h82.2l-69,159h-199l-2-5.3c-10.2-27,9.8-55.9,38.7-55.9H290c19.1,0,36.3-11.6,43.6-29.3
	l16-39.1C356.8,197.3,374.1,185.7,393.4,185.7z"
    ></path>
    <path
      d="M183.4,303.1l-50.3-133.5H89.6c-4.4,0-8-3.6-8-8s3.6-8,8-8h49c3.3,0,6.3,2.1,7.5,5.2l54.4,144.3h15c4.4,0,8,3.6,8,8
	...
	S233.2,403.8,233.2,419.6z"
    ></path>
    <g>
      <path
        fill="#EFF3EE"
        className="primary-color"
        d="M483.5,103.1v35.8H288.5v-35.8H483.5z"
      ></path>
      <path
        fill="#FFA600"
        className="secondary-color"
        d="M487.7,41.4v39.3H284.3V41.4H487.7z"
      ></path>
    </g>
    <path
      d="M223.5,80.2c0,4.4-3.6,8-8,8h-67.8c-4.4,0-8-3.6-8-8s3.6-8,8-8h67.8C219.9,72.2,223.5,75.8,223.5,80.2z M166.2,455.2H52.5
	...
	C471.6,333.5,476,337.9,476,343.4z M46,384.4c0,5.5-4.4,9.9-9.9,9.9s-9.9-4.4-9.9-9.9c0-5.5,4.4-9.9,9.9-9.9S46,379,46,384.4z"
    ></path>
  </svg>
)
